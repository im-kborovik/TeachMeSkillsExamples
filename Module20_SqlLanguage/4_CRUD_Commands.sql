...
insert into Products -- после названия таблицы мы можем в скобка ещё указать те колонки, которым хотим указать значения,
    ...
    values (N'Картоха', '1113');
-- можно указывать несколько записей за раз
insert into Products
values (N'Картоха', '1112'),
       (N'Макарохи', '1234'),
       (N'Рис', '1122');
    
-- 2. Чтобы обновить записи используем update
update Products set Name = N'Редька'; -- такой командой мы заменим все имена в таблицы на 'Редька'
...
select *
from Products
where not Article = '111' or Name = N'Картоха';
...
update Products set Name = N'Молоко' where Article = '1111';
...
select *
from Products
where Name in (N'Картоха', N'Морковка');
